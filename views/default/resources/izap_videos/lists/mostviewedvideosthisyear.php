...
elgg_push_breadcrumb(elgg_echo('izap_videos:mostviewedthisyear'));
...
$title = elgg_echo('izap_videos:mostviewedthisyear');
...
if (!empty($result)) {
	...
	$area2 = elgg_echo('izap_videos:mostviewedthisyear:nosuccess');
}
...
// Draw it
echo elgg_view_page(elgg_echo('izap_videos:mostviewedthisyear'), $body);
